...
class AtomicView::Components::CardComponentTest < ViewComponent::TestCase
  test "renders a plain card by default" do
    ...
    expected = <<~HTML.strip
      <div class="bg-surface rounded-card border border-border p-2.5">Content</div>
    HTML
  ...
  test "adds hover shadow classes when hoverable" do
    ...
    expected = <<~HTML.strip
      <div class="bg-surface rounded-card border border-border p-2.5 hover:shadow-soft transition-shadow">Content</div>
    HTML
  ...
  test "merges custom class and forwards other options" do
    ...
    expected = <<~HTML.strip
      <div id="profile-card" class="bg-surface rounded-card border border-border p-2.5 custom-card">Content</div>
    HTML
