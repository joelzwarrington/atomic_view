...
class AtomicView::Components::CollectionRadioButtonsComponentTest < ViewComponent::TestCase
  ...
  test "renders basic collection radio buttons" do
    ...
    expected = <<~HTML.strip
      <div class="flex flex-col gap-2">
        <input type="hidden" name="test_model[role]" value="" autocomplete="off"><div class="flex items-center gap-2">
      <input class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="admin" name="test_model[role]" id="test_model_role_admin"><label for="test_model_role_admin">Admin</label>
      </div>
  ...
  test "renders collection radio buttons with object collection" do
    ...
    expected = <<~HTML.strip
      <div class="flex flex-col gap-2">
        <input type="hidden" name="test_model[role]" value="" autocomplete="off"><div class="flex items-center gap-2">
      <input class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="admin" name="test_model[role]" id="test_model_role_admin"><label for="test_model_role_admin">Administrator</label>
      </div>
      <div class="flex items-center gap-2">
  ...
  test "renders collection radio buttons with different field name" do
    ...
    expected = <<~HTML.strip
      <div class="flex flex-col gap-2">
        <input type="hidden" name="test_model[status]" value="" autocomplete="off"><div class="flex items-center gap-2">
      <input class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="active" name="test_model[status]" id="test_model_status_active"><label for="test_model_status_active">Active</label>
      </div>
      <div class="flex items-center gap-2">
      <input class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="inactive" name="test_model[status]" id="test_model_status_inactive"><label for="test_model_status_inactive">Inactive</label>
      </div>
      <div class="flex items-center gap-2">
  ...
  test "renders collection radio buttons with required attribute" do
    ...
    expected = <<~HTML.strip
      <div class="flex flex-col gap-2">
        <input type="hidden" name="test_model[role]" value="" autocomplete="off"><div class="flex items-center gap-2">
      <input required="required" class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="admin" name="test_model[role]" id="test_model_role_admin"><label for="test_model_role_admin">Admin</label>
      </div>
      <div class="flex items-center gap-2">
      <input required="required" class="peer border-input dark:bg-input/30 checked:bg-primary checked:text-primary-foreground dark:checked:bg-primary checked:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-full border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50" type="radio" value="user" name="test_model[role]" id="test_model_role_user"><label for="test_model_role_user">User</label>
      </div>
