...
class AtomicView::Components::DatetimeLocalFieldComponentTest < ViewComponent::TestCase
  ...
  test "renders datetime local field with disabled attribute" do
    ...
    expected = <<~HTML.strip
      <div class="relative rounded-btn shadow-xs">
        <input disabled class="block w-full appearance-none h-8 min-w-0 z-10 flex-1 rounded-btn border-0 py-1 shadow-xs ring-1 text-base disabled:cursor-not-allowed disabled:bg-disabled disabled:text-disabled-foreground disabled:ring-disabled-ring bg-transparent dark:bg-white/5 text-foreground ring-ring/10 dark:ring-white/10 placeholder:text-placeholder focus:ring-focus-ring focus:border-ring/20 dark:focus:ring-focus-ring" type="datetime-local" name="test_model[appointment_time]" id="test_model_appointment_time">
      </div>
    HTML
  ...
  test "renders datetime local field with readonly attribute" do
    ...
    expected = <<~HTML.strip
      <div class="relative rounded-btn shadow-xs">
        <input readonly class="block w-full appearance-none h-8 min-w-0 z-10 flex-1 rounded-btn border-0 py-1 shadow-xs ring-1 text-base disabled:cursor-not-allowed disabled:bg-disabled disabled:text-disabled-foreground disabled:ring-disabled-ring bg-transparent dark:bg-white/5 text-foreground ring-ring/10 dark:ring-white/10 placeholder:text-placeholder focus:ring-focus-ring focus:border-ring/20 dark:focus:ring-focus-ring" type="datetime-local" name="test_model[appointment_time]" id="test_model_appointment_time">
      </div>
    HTML
