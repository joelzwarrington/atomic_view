  ...
  test "renders empty collection gracefully" do
    ...
    expected = <<~HTML.strip
      <div class="flex flex-col gap-2">
        <input type="hidden" name="test_model[tags][]" value="">
      </div>
    HTML
