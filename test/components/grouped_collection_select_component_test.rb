...
class AtomicView::Components::GroupedCollectionSelectComponentTest < ViewComponent::TestCase
  ...
  test "renders grouped collection select with html options" do
    ...
    expected = "<input name=\"test_model[country][]\" type=\"hidden\" value=\"\"><select class=\"custom-select block w-full appearance-none h-8 min-w-0 z-10 flex-1 rounded-btn border-0 py-1 shadow-xs ring-1 text-sm disabled:cursor-not-allowed disabled:bg-disabled disabled:text-disabled-foreground disabled:ring-disabled-ring bg-transparent dark:bg-white/5 text-foreground ring-ring/10 dark:ring-white/10 placeholder:text-placeholder focus:ring-focus-ring focus:border-ring/20 dark:focus:ring-focus-ring\" multiple=\"multiple\" name=\"test_model[country][]\" id=\"test_model_country\"><optgroup label=\"North America\"><option value=\"us\">United States</option>\n<option value=\"ca\">Canada</option></optgroup><optgroup label=\"Europe\"><option value=\"uk\">United Kingdom</option>\n<option value=\"de\">Germany</option></optgroup></select>"
