...
class AtomicView::Components::BadgeComponentTest < ViewComponent::TestCase
  test "renders default variant by default" do
    ...
    expected = <<~HTML.strip
      <span class="inline-flex items-center rounded-pill px-2 py-0.5 text-xs font-medium bg-primary text-primary-foreground">Active</span>
    HTML
  ...
  test "renders secondary variant" do
    ...
    expected = <<~HTML.strip
      <span class="inline-flex items-center rounded-pill px-2 py-0.5 text-xs font-medium bg-secondary text-secondary-foreground">Draft</span>
    HTML
  ...
  test "renders destructive variant" do
    ...
    expected = <<~HTML.strip
      <span class="inline-flex items-center rounded-pill px-2 py-0.5 text-xs font-medium bg-destructive text-destructive-foreground">Needs attention</span>
    HTML
  ...
  test "renders outline variant" do
    ...
    expected = <<~HTML.strip
      <span class="inline-flex items-center rounded-pill px-2 py-0.5 text-xs font-medium bg-transparent border border-border text-foreground">Pending</span>
    HTML
  ...
  test "merges custom class and forwards other options" do
    ...
    expected = <<~HTML.strip
      <span id="status-badge" class="inline-flex items-center rounded-pill px-2 py-0.5 text-xs font-medium bg-primary text-primary-foreground custom-badge">Active</span>
    HTML
